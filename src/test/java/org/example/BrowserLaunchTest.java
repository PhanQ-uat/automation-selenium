...
public class BrowserLaunchTest extends BaseTest {
    ...
    @Test
    public void testFirefoxBrowserLaunch() {
        WebDriver driver = getDriver();
        ...
        // Verify page title
        String title = driver.getTitle();
        Assert.assertTrue(title.contains("Mozilla"), "Page title should contain 'Mozilla'");

        // Verify current URL
        String currentUrl = driver.getCurrentUrl();
        Assert.assertTrue(currentUrl.contains("mozilla.org"), "URL should contain 'mozilla.org'");
